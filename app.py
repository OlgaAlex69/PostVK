...
def get_system_prompt(mood):
    ...
    mood_descriptions = {
        "радостный": "Тон: очень позитивный, восторженный, с эмодзи. Передай искреннюю радость от товара.",
        "вдохновляющий": "Тон: мотивирующий, вдохновляющий. Покажи, как товар меняет жизнь к лучшему.",
